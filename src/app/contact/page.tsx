          ...
          <div className="flex-1 space-y-8 lg:pt-10">
            ...
            <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm mt-8">
               ...
               <div className="space-y-2 font-medium text-gray-600">
                  <p className="flex justify-between"><span>Monday to Saturday:</span> <span className="text-gray-900 font-bold">9:00 AM – 7:00 PM</span></p>
                  <p className="flex justify-between"><span>Sunday:</span> <span className="text-[#FF7300] font-bold">Closed / By Appointment</span></p>
               </div>
            </div>
          </div>
      ...
      <section className="py-24 px-6 md:px-20 bg-white" id="map">
         ...
         <div className="max-w-7xl mx-auto rounded-[3rem] overflow-hidden shadow-2xl border border-gray-100 flex flex-col lg:flex-row relative z-10">
            <div className="w-full lg:w-2/3 h-[400px] lg:h-auto bg-gray-200">
               ...
               <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3491.5644784400713!2d75.71960251508272!3d29.14170364951474!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3912332e185c07b7%3A0xe54e17e3f81e3a64!2sNext%20Gen%20Academy!5e0!3m2!1sen!2sin!4v1680101010101!5m2!1sen!2sin" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
            ...
            <div className="w-full lg:w-1/3 bg-gray-900 p-12 text-white flex flex-col justify-center">
               ...
               <div className="flex items-start gap-4 mb-6">
                 ...
                 <div>
                    ...
                    <p className="text-gray-400 font-medium leading-relaxed">Sco 125, First Floor, PLA Shopping Complex, Police Line Area<br/>Hisar, Haryana 125001</p>
                 </div>
               </div>
